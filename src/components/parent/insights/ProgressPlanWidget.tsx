  ...
  return (
    <div className="bg-background rounded-2xl shadow-sm p-6 border border-border">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-lg font-bold text-primary mb-1">Progress vs Plan</h3>
      ...
      <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-border">
        <div className="flex items-center space-x-2">
          <div className="w-10 h-10 bg-success bg-opacity-10 dark:bg-green-900/30 rounded-lg flex items-center justify-center">
        ...
        <div className="flex items-center space-x-2">
          <div className="w-10 h-10 bg-warning bg-opacity-10 dark:bg-amber-900/30 rounded-lg flex items-center justify-center">

...
export default function QuickActions({
  ...
  const actions = [
    {
      icon: <AppIcon name="calendar-plus" className="w-5 h-5 text-primary-600" />,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {actions.map((action, index) => (
          <button
            ...
            className="p-4 rounded-lg border border-neutral-200 hover:border-primary-600 hover:bg-primary-50 transition-colors text-left"
          >
            <div

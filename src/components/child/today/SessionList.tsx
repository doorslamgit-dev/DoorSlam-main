  ...
  return (
    <div className="bg-background rounded-2xl shadow-sm p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-bold text-primary">Today's Sessions</h2>
      ...
      {sessions.length === 0 ? (
        <div className="text-center py-8">
          ...
          <h3 className="text-lg font-semibold text-primary mb-2">No sessions today</h3>
        ...
        <>
          ...
          {nextSessionId && (
            <button
              ...
              className="w-full bg-primary text-primary-foreground font-semibold py-4 rounded-xl hover:bg-primary/90 transition flex items-center justify-center space-x-2"
            >
...
function SessionItem({
  ...
  const getStatusBadge = () => {
    ...
    return (
      <div className="bg-border px-3 py-1 rounded-full">
  ...
  return (
    <div
      className="flex items-start space-x-3 p-4 bg-muted rounded-xl cursor-pointer hover:bg-accent transition"
      onClick={onStart}
    >
      <div

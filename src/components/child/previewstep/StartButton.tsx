    ...
    <div className="bg-background rounded-2xl shadow-soft p-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-8 py-4 bg-primary text-white font-semibold rounded-xl hover:bg-primary/90 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <span>{isStarting ? "Starting..." : "Start Session"}</span>
          <AppIcon name={arrowIcon} className="text-white" />
        </button>
      </div>
    </div>
  );

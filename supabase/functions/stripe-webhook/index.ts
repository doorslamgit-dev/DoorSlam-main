...
// =============================================================================
// Tier mapping from price to tier
// Update these with your actual Stripe price IDs
// =============================================================================

const PRICE_TO_TIER: Record<string, string> = {
  // Family tier prices
  "price_family_1mo": "family",
  "price_family_3mo": "family",
  "price_family_12mo": "family",
  "price_family_annual": "family",
  // Premium tier prices
  "price_premium_1mo": "premium",
  "price_premium_3mo": "premium",
  "price_premium_12mo": "premium",
  ...
  try {
    switch (event.type) {
      ...
      case "invoice.paid": {
        ...
        // Could log for analytics, but subscription.updated handles the status
        break;
      }

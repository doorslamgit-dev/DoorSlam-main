...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'limits', CASE v_profile.subscription_tier
      WHEN 'trial' THEN jsonb_build_object('max_children', 1, 'max_subjects', 1)
      WHEN 'family' THEN jsonb_build_object('max_children', null, 'max_subjects', null)
      WHEN 'premium' THEN jsonb_build_object('max_children', null, 'max_subjects', null, 'can_buy_tokens', true)
      ELSE jsonb_build_object('max_children', 0, 'max_subjects', 0)
    END
  );
END;
$$;
...
-- =============================================================================
-- 6. Set trial_ends_at for new users (trigger)
-- =============================================================================
